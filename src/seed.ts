...
createConnection().then(async connection => {
  ...
  const userPassword = bcrypt.hashSync(user_password, salt);
  const adminPassword = bcrypt.hashSync(admin_password, salt);
  // console.log(bcrypt.compareSync(user_password, userPassword));
